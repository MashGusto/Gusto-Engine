...
Player::Player(Vector2f pos, Vector2f size, float mass, std::string textureImagePath, float textureImageScale) : m_position(pos), m_size(size), m_mass(mass), m_shader(FileManager::getShader("Texture/vertexShader.glsl"), FileManager::getShader("Texture/fragmentShader.glsl"))
{
  m_mass;
